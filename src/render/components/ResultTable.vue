                ...
                <div class="d-flex justify-content-end">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" @click="exportTable('excel')">Excel</a>
                            <a class="dropdown-item" @click="exportTable('pdf')">PDF</a>
                            <a class="dropdown-item" @click="exportTable('doc')">DOC</a>
                            <a class="dropdown-item" @click="exportTable('txt')">TXT</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" @click="exportTable('json')">JSON</a>
                            <a class="dropdown-item" @click="exportTable('xml')">XML</a>
                        </div>
                    </div>
                </div>
                <table class="table table-bordered" style="overflow-y: auto;" id="dataTable" width="100%"
                    ...
                    <tbody>
                        <tr v-for="result in results" :key="result.id">
                            ...
                            <td>
                                <div  style="overflow: auto">{{ result.abstract || '---' }}
                                </div>
                            </td>
